...
const infoItems = [
  { icon: MapPin, label: "Adresse",        value: "Große Elbstraße 47\n22767 Hamburg-Altona" },
  { icon: Phone,  label: "Telefon",        value: "+49 40 38 76 54 90" },
  { icon: Mail,   label: "E-Mail",         value: "hallo@haarhafen.de" },
  { icon: Clock,  label: "Öffnungszeiten", value: "Mo–Fr: 09:00–19:00\nSa: 09:00–17:00\nSo: geschlossen" },
]
...
export function Kontakt() {
  ...
  return (
    <section id="kontakt" style={{ background: "#0f0f0f", padding: "9rem 1.5rem" }}>
        ...
        >
          ...
          <AnimateOnScroll>
            {success ? (
              ...
              >
                <CheckCircle size={40} style={{ color: "#C9A86C", marginBottom: "1rem" }} strokeWidth={1.2} />
              ...
              <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div>
                  <input
                    ...
                    onFocus={e => { e.currentTarget.style.borderColor = "rgba(201,168,108,0.5)" }}
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 500,
                    fontSize: "0.9rem",
                    background: loading ? "rgba(201,168,108,0.5)" : "#C9A86C",
                    color: "#0a0a0a",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
              {infoItems.map(item => (
                <div key={item.label} className="flex" style={{ gap: "1.25rem" }}>
                  ...
                  >
                    <item.icon size={15} style={{ color: "#C9A86C" }} strokeWidth={1.5} />
                  </div>
                  <div>
                    <p
              ...
              <div
                ...
                style={{
                  height: "170px",
                  borderRadius: "1rem",
                  background: "linear-gradient(135deg, #0e1218 0%, #141c24 50%, #0a0e14 100%)",
              ...
              >
                <div className="text-center">
                  <MapPin
                    size={22}
                    style={{ color: "#C9A86C", margin: "0 auto", marginBottom: "0.5rem" }}
                    strokeWidth={1.5}
                  />
                  <p style={{ fontSize: "0.78rem", color: "rgba(255,255,255,0.35)" }}>
                    Große Elbstraße 47 · Hamburg-Altona
                  </p>
                </div>
              </div>
            </div>
